...
NAMESPACES = {"2012": "http://www.openmicroscopy.org/Schemas/OME/2012-06",
              "2013": "http://www.openmicroscopy.org/Schemas/OME/2013-06",
              "2015": "http://www.openmicroscopy.org/Schemas/OME/2015-01"}
...
class OMEModel():
    ...
    def __init__(self, xml_str):
        ...
        for k, v in NAMESPACES.items():
            ...
            self.img = self.root.find("{{{}}}Image".format(v))
            self.ns = v
            self.ns_year = k
